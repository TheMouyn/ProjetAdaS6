with ada.text_io, outils, gestion_personnel, gestion_commande, gestion_client, nt_console;
use ada.text_io, outils, gestion_personnel, gestion_commande, gestion_client, nt_console;
